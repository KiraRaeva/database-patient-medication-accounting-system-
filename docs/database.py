...
class DatabaseManager:
    ...
    def __init__(self, db_name: str = "medical_system.db"):
        ...
        print(f"База данных будет создана в: {os.path.abspath(self.db_name)}")
        self.init_database()
    ...
    def init_database(self):
        ...
        with self.get_connection() as conn:
            ...
            # Создание таблицы Пользователи (Пациенты) с аутентификацией
            cursor.execute('''
            ...
            # Создание таблицы Медицинских работников с аутентификацией
            cursor.execute('''
            ...
            # Создание таблицы Приёмов лекарств с статусом
            cursor.execute('''
